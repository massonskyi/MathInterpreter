...
public:
    ...
    {
        std::stringstream ss;
        ss << "Vector of Variable" << vector_.at(0).getType() << " with size " << size() << ": [";
    ...
    inline void add(std::shared_ptr<Variable> object)
    {
        try
        {
            if (!object)
    ...
    /// @param index of the object
    /// @return object by index
    inline Variable get(size_t index) const
    {
        try
        {
    ...
    /// @return data vector
    inline std::vector<Variable> getData() const
    {
        return vector_;
    }
    ...
    /// @param index of the object
    /// @return object by index
    inline Variable at(size_t index) const
    {
        return vector_.at(index);
    }
    ...
    inline std::shared_ptr<Variable> ptr(size_t index) const
    {
        try
        {
            if (index >= vector_.size())
    ...
    inline std::shared_ptr<Variable> front() const
    {
        try
        {
            if (vector_.empty())
    ...
    inline std::shared_ptr<Variable> back() const
    {
        try
        {
            if (vector_.empty())
    ...
    inline void push_back(const Variable &var)
    {
        try
        {
    ...
    inline void push_back(const _Tp &var)
    {
        try
        {
    ...
    /// @brief This method adds object to the container end of the container
    /// @param var to add to the container
    inline void append(const Variable &var)
    {
        try
        {
            vector_.push_back(var);
    ...
    /// @param var to add to the container
    template <AllowedTypes _Tp>
    inline void append(const _Tp &var)
    {
        try
        {
            vector_.push_back(Variable(var));
    ...
    /// @param var to add to the container
    inline void insert(size_t index, const Variable &var)
    {
        try
        {
            if (index > vector_.size())
    ...
    /// @param var to add to the container
    template <AllowedTypes _Tp>
    inline void insert(size_t index, const _Tp &var)
    {
        try
        {
            if (index > vector_.size())
    ...
    /// @brief This method swaps two containers
    /// @param other container
    inline void swap(std::vector<Variable> &other) noexcept
    {
        try
        {
            vector_.swap(other);
    ...
    std::vector<Variable>::const_iterator cbegin() const noexcept
    {
    ...
    std::vector<Variable>::const_iterator cend() const noexcept
    {
        return vector_.cend();
    }
